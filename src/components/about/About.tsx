import ProfilePhoto from "../../assets/face_crop.webp";
        ...
        <div className={styles.container}>
            ...
            <p>
                ...
                <span className={styles.highlight}>
                    Technical Engineering in Computer Management at the
            ...
            <p>
                ...
                {`, I understand the whole process of building software, 
            ...
            <p>
                {`For the last three years, I’ve been living in `}{" "}
                <span className={styles.highlight}>Trondheim, Norway</span>
                {`. Here, 
